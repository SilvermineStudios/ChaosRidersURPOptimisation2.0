...
public class SoundControllerMultiplayer : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        car = GetComponent(typeof(CarControllerMultiplayer)) as CarControllerMultiplayer;
    ...
    void Update()
    {
        ...
        else if ((float)currSpeed < (float)((float)lastSpeed - 3.2f))
        { //slowing down
            lastSpeed = currSpeed;
            //low
